...
export default function  UpdateCategories () {
    ...
    const {data:dataList, loading:list, error:erreulist}=  getOne<Categories>(permissionRequest.endpoint.GETONE(id),"GET");
    useEffect(()=>{
    ...
    const handleUpdate= async (e:React.FormEvent)=>{
        ...
        await addData(permissionRequest.endpoint.POST(), "POST","/Stock/categories_produits",  categories);
