...
const AjouterCategorie = () => {
  ...
  const {data:Allcategories, loading:loadCat, error:ErrCat} = useFetchData<Categories[]>(rolesRequest.endpoint.GET(),"GET")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    await addData(rolesRequest.endpoint.POST(), "POST","#", categorie, );
  };
