...
export default function  UpdateCategories () {
    ...
    const {data:Allcategories, loading:loadCat, error:ErrCat} = useFetchData<Categories[]>(ressourcesRequest.endpoint.GET(),"GET")

    const {data:dataList, loading:list, error:erreulist}=  getOne<Categories>(ressourcesRequest.endpoint.GETONE(id),"GET");
    useEffect(()=>{
    ...
    const handleUpdate= async (e:React.FormEvent)=>{
        ...
        await addData(ressourcesRequest.endpoint.POST(), "POST","/Stock/categories_produits",  categories);
