            ...
            <div className="col-md-6">
              ...
              <div className="box">
                ...
                <div className="box-body">
                  <button className="btn btn-default btn-block">.btn-block</button>
                  <button className="btn btn-default btn-block btn-flat">.btn-block .btn-flat</button>
                  <button className="btn btn-default btn-block btn-sm">.btn-block .btn-sm</button>
                </div>
              </div>
              {/* <!-- /.box --> */}
              ...
              <div className='box'>
                ...
                <div className='box-body table-responsive pad'>
                  <p>
                    ...
                    inside <code>&lt;div className="btn-group"&gt;&lt;/div&gt;</code>
                  </p>
                ...
                <div className="box-body">
                  ...
                  <div className="input-group margin">
                    <div className="input-group-btn">
                      <button type="button" className="btn btn-default dropdown-toggle" data-toggle="dropdown">Action <span className="fa fa-caret-down"></span></button>
                      <ul className="dropdown-menu">
              ...
              <div className="box">
                <div className="box-header">
                  <h3 className="box-title">Social Buttons (By <a href="https://github.com/lipis/bootstrap-social">Lipis</a>)</h3>
                </div>
                <div className="box-body">
            ...
            <div className="col-md-6">
              ...
              <div className="box">
                ...
                <div className="box-body">
                  ...
                  <p>
                    <button className="btn bg-maroon btn-flat margin">.btn.bg-maroon.btn-flat</button>
                    <button className="btn bg-purple btn-flat margin">.btn.bg-purple.btn-flat</button>
                    <button className="btn bg-navy btn-flat margin">.btn.bg-navy.btn-flat</button>
                    <button className="btn bg-orange btn-flat margin">.btn.bg-orange.btn-flat</button>
                    <button className="btn bg-olive btn-flat margin">.btn.bg-olive.btn-flat</button>
                  </p>

                  <p>
                    <button className="btn bg-maroon margin">.btn.bg-maroon</button>
                    <button className="btn bg-purple margin">.btn.bg-purple</button>
                    <button className="btn bg-navy margin">.btn.bg-navy</button>
                    <button className="btn bg-orange margin">.btn.bg-orange</button>
                    <button className="btn bg-olive margin">.btn.bg-olive</button>
                  </p>
                </div>
              </div>
              {/* <!-- /.box --> */}
              ...
              <div className='box'>
                ...
                <div className='box-body table-responsive pad'>
                  ...
                  <p>
                    ...
                    inside <code>&lt;div className="btn-group-vertical"&gt;&lt;/div&gt;</code>
                  </p>
