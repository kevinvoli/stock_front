              ...
              <div className='row'>
                ...
                <div className='col-sm-4 col-md-2'>
                  ...
                  <div className='color-palette-set'>
                    ...
                    <div className='bg-orange color-palette'><span>#00a65a</span></div>
            ...
            <div className="col-md-6">
              <div className="box box-solid">
                ...
                <div className="box-body text-center">
                  ...
                  <div className="progress vertical">
                    <div className="progress-bar progress-bar-red" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style={{height: "40%"}}>
